...
| Лабораторная 3 | `gistogram/*.h`                 | Построение гистограммы  Кеширование данных DSL для работы с гистограммами [gistogram](gistogram)                                                                                                                                                                                                                                                                                                                   | Да [ui](ui) runGistTestsUI() и использование функционала в нативной библиотеке                                                                                                                                                                                                                                                                                                                                       | [dict](test/dict) [hashmap](test/hashmap)    [Gistogram](api/Gistogram)  - модульные и нагрузочные                                                                                                                                                                               | [dict](test/dict) [hashmap](test/hashmap)    [Gistogram](api/Gistogram)  - модульные и нагрузочные                                                                                                                                           |
| Лабораторная 4 | `graph/*.h`       | Генерация графов с логистическими данными <br/>Поддержка как направленных, так и ненаправленных графов <br/> Поддержка текстовых форматов файлов с описанием графа <br/> Анализ графов <br/>REST API с использованием Kotlin + Spring Boot ([api](api)) и нативной библиоткеи   [jni](jni)                                                                                                                         | Веб-интерфейс через API (в swagger) и  ([ui](ui)) runUIGraf();                                                                                                                                                                                                                                                                                                                                                       | Тесты для CRUD и логики.   [graph](test/graph)                                                                                                                                                                                                                                                     | Тесты производительности API .  [graph](test/graph)                                                                                                                                                                                                                |

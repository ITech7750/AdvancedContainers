#ifndef LABA4_BUILDLOGISTICGRAPHFROMFILEUSECASE_H
#define LABA4_BUILDLOGISTICGRAPHFROMFILEUSECASE_H
...
class BuildLogisticGraphFromFileUseCase {
public:
    s_Graph<Road, City> operator()(String filePath) {
        s_Graph g = s_Graph<Road, City>();
...
#endif //LABA4_BUILDLOGISTICGRAPHFROMFILEUSECASE_H

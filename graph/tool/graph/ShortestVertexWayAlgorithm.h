#ifndef GISTOGRAMBAG_SHORTESTVERTEXWAYALGORITHM_H
#define GISTOGRAMBAG_SHORTESTVERTEXWAYALGORITHM_H
...
template $graph
class ShortestVertexWayAlgorithm : public Algorithm {
public:
    Graph* operator()(Graph graph, City start, City end) {
...
#endif //GISTOGRAMBAG_SHORTESTVERTEXWAYALGORITHM_H
